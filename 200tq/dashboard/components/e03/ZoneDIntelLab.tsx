...
export default function ZoneDIntelLab({ vm, selectedPeriod, onPeriodChange, startCapital = 10000000 }: ZoneDIntelLabProps) {
  ...
  return (
    <details className="group border-t border-neutral-800 pt-8 mt-0">
      <summary className="list-none cursor-pointer flex items-center justify-between text-neutral-500 hover:text-neutral-300 transition-colors">
      ...
      <div className="pt-4 pb-8 space-y-6">
         ...
         <details className="text-xs text-neutral-600">
           <summary className="cursor-pointer font-sans text-neutral-500 hover:text-neutral-400 text-[10px] uppercase tracking-wider">
             고급 정보
           </summary>
